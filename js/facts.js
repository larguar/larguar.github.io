$(document).ready(()=> {
	...
	let facts = {
		...
		12: {
			fact: "My mom bought me Photoshop for Christmas in 7th grade.",
			image: "img/erica.jpg"
		},
		13: {
			fact: "If it's nice out, I'm WFH (Working From Hammock).",
			image: "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExcGZpbTAzZDRyYWQwZ2dpM3h4Nmo2YzQ1bjY3djhxZnZ2eXhxd2Q0diZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/xUNd9YPkhIBH2yFiN2/giphy.gif"
		}
	};
	...
	if (i >= 0) {
		let p = $('<p>').addClass('comment').html('// icebreaker: ' + facts[i].fact);
